# Evaluation: Hightouch - Software Engineer, Distributed Systems
...
**Hightouch** is hiring **Software Engineer, Distributed Systems**. Parsed location/context: Remote (North America). The role appears to focus on data pipeline engineer responsibilities.
...
Score 3.7/5. Skip or hold until proof points improve.
