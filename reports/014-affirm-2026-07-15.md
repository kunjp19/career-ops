# Evaluation: Affirm - Senior Software Engineer, Backend (Continuous Delivery)

**Date:** 2026-07-15
**URL:** https://job-boards.greenhouse.io/affirm/jobs/7703207003
**Archetype:** Cloud Backend Engineer / Platform Engineer
**Score:** 4.7/5
**Legitimacy:** High Confidence
**PDF:** output/cv-kunjkumar-patel-affirm-senior-software-engineer-backend-continuous-delivery-2026-07-15.pdf

---

## A) Role Summary

**Affirm** is hiring **Senior Software Engineer, Backend (Continuous Delivery)**. Parsed location/context: Remote US. The role appears to focus on cloud backend engineer / platform engineer responsibilities.
...
- JD length: 13861 characters
- Description specificity: SQL, distributed systems, AWS, Kubernetes, CI/CD, Python, Go, remote-first, Affirm
...
SQL, distributed systems, AWS, Kubernetes, CI/CD, Python, Go, remote-first, Affirm
