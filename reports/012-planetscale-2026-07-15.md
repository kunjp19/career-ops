# Evaluation: PlanetScale - Software Engineer - Insights
...
**PlanetScale** is hiring **Software Engineer - Insights**. Parsed location/context: San Francisco Bay Area or Remote. The role appears to focus on data pipeline engineer responsibilities.
...
Score 3.8/5. Skip or hold until proof points improve.
...
- JD length: 4772 characters
- Description specificity: SQL, Postgres, Kafka, distributed systems, Python, Go
...
SQL, Postgres, Kafka, distributed systems, Python, Go
