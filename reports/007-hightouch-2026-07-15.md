# Evaluation: Hightouch - Software Engineer, Control Plane
...
**Hightouch** is hiring **Software Engineer, Control Plane**. Parsed location/context: Remote (North America). The role appears to focus on data pipeline engineer responsibilities.
...
- JD length: 6017 characters
- Description specificity: distributed systems, Go, agentic
...
distributed systems, Go, agentic
