# Evaluation: Hightouch - Software Engineer, Streaming Systems
...
**Hightouch** is hiring **Software Engineer, Streaming Systems**. Parsed location/context: Remote (North America). The role appears to focus on cloud backend engineer / platform engineer responsibilities.
...
- JD length: 5953 characters
- Description specificity: Kafka, distributed systems, Go, Cursor, agentic
...
Kafka, distributed systems, Go, Cursor, agentic
