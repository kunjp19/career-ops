# Evaluation: Affirm - Senior CIAM Software Engineer
...
**PDF:** output/cv-kunjkumar-patel-affirm-senior-ciam-software-engineer-2026-07-15.pdf

---

## A) Role Summary

**Affirm** is hiring **Senior CIAM Software Engineer**. Parsed location/context: Remote US. The role appears to focus on cloud backend engineer / platform engineer responsibilities.
...
Score 4.6/5. Apply now after reviewing tailored materials.
...
- JD length: 7474 characters
- Description specificity: distributed systems, AWS, Terraform, CI/CD, Python, Go, Cursor, remote-first, Affirm
...
distributed systems, AWS, Terraform, CI/CD, Python, Go, Cursor, remote-first, Affirm
